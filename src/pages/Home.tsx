...
export default function Home() {
  ...
  return (
    <div>
      ...
      {/* Hero Section */}
      <section ref={heroRef} className="relative min-h-[80vh] md:min-h-[90vh] flex items-center overflow-hidden bg-gradient-to-br from-primary via-primary-dark to-[#2D0A18]">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 w-full">
          <div className={`max-w-2xl transition-all duration-1000 ${heroInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <img src="/name.png" alt={settings?.siteName || 'دنيا العرائس'} className="h-14 md:h-20 lg:h-28 w-auto mb-3 md:mb-5" />
            <p className="text-sm md:text-xl text-white/70 mb-6 md:mb-10 leading-relaxed max-w-lg">
